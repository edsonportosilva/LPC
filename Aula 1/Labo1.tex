...
\begin{questions}
    \question Para os sinais periódicos com período $T$ ilustrados na Figura \ref{fig:sinaisusuais}, mostre que os coeficientes das séries trigonométricas de Fourier escritas forma 
    \begin{equation}
