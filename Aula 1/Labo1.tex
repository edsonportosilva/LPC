...
\begin{questions}
    ...
    \begin{parts}
        ...
        \fillwithlines{0.5in}
        \part Novamente na aba {\bf Deslocamento de fase}, altere os valores do deslocamento de fase da primera, segunda e terceira componentes para 2000, 4000 e 6000, respectivamente. Houve distorção? Explique o que ocorre nesta configuração.
        \fillwithlines{0.5in}
