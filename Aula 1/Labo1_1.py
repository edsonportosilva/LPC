...
# Title: Experimentando o GRC
# Author: Leocarlos B S Lima
...
# Generated: Thu Jun  6 15:23:18 2019
##################################################
...
class Labo1_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Experimentando o GRC")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Experimentando o GRC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labo1_1")
...
def main(top_block_cls=Labo1_1, options=None):
