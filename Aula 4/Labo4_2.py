...
class Labo4_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM de Faixa Larga")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM de Faixa Larga")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labo4_2")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 4*32000
        self.Fp = Fp = 20000
        self.F = F = 50
        self.A = A = 0.5
        ...
        # Blocks
        ##################################################
        self._Fp_range = Range(10000, 30000, 500, 20000, 200)
        self._Fp_win = RangeWidget(self._Fp_range, self.set_Fp, 'Frequencia da portadora', "counter_slider", float)
        self.top_grid_layout.addWidget(self._Fp_win, 0, 2, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._F_range = Range(0, 1000, 50, 50, 200)
        self._F_win = RangeWidget(self._F_range, self.set_F, 'Frequencia do sinal modulante', "counter_slider", float)
        self.top_grid_layout.addWidget(self._F_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._A_range = Range(0, 1, 0.1, 0.5, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, 'Amplitude do sinal modulante', "counter_slider", float)
    ...
    def set_Fp(self, Fp):
        self.Fp = Fp
        self.blocks_add_const_vxx_0.set_k((self.Fp/10000.0, ))
...
def main(top_block_cls=Labo4_2, options=None):
