...
\begin{questions}
    ...
    \question Qual a largura de faixa da portadora FM modulada calculada pela regra de Carson e a largura de faixa de 10dB observada no espectro em frequências?%redução de aproximadamente 10 dB sobre as de maior potência)?
    \fillwithlines{0.25in}
    ...
    \fillwithlines{1.1in}
%    \question Altere a amplitude do sinal modulante para $1,5$. Qual a nova largura de faixa do sinal modulado pela regra de Carson e observando-se o espectro de frequências, considerando $K_{f} = 10^{4}$~Hz/V?
%    \fillwithlines{0.25in}
