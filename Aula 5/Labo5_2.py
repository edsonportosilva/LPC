...
# Title: Labo5 2
# Generated: Fri Dec  6 15:00:21 2019
##################################################
...
class Labo5_2(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.Channel, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.Channel, 0), (self.interp_fir_filter_xxx_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.blocks_complex_to_real_0_0_0, 0))
        self.connect((self.low_pass_filter_0_0_0_0, 0), (self.Channel, 0))
