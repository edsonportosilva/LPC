...
class Labo3_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labo3_1")
        ...
        # Blocks
        ##################################################
        self._F_range = Range(2000, 8000, 200, 5000, 200)
        self._F_win = RangeWidget(self._F_range, self.set_F, 'Freq Portadora', "counter_slider", float)
        self.top_grid_layout.addWidget(self._F_win, 2, 0, 1, 1)
        for r in range(2, 3):
        ...
        self.Sinal_Modulante = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200, 1, 0)
        self.Portadora = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, F, 1, 0)
    ...
    def set_F(self, F):
        self.F = F
        self.Portadora.set_frequency(self.F)
...
def main(top_block_cls=Labo3_1, options=None):
