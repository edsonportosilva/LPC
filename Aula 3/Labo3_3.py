...
class Labo3_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Detecção de envoltória de AM-DSB")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Detecção de envoltória de AM-DSB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labo3_3")
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
        	1000, #size
        	samp_rate, #samp_rate
        	'Sinal Desmodulado por Deteccao da Envoltoria', #name
        	1 #number of inputs
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
        	...
        	0, #fc
        	samp_rate, #bw
        	'Espectros de Amplitude dos Sinais Modulado e Desmodulado', #name
        	2 #number of inputs
        )
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.dc_blocker_xx_0_0 = filter.dc_blocker_ff(1000, True)
        ...
        self.connect((self.dc_blocker_xx_0_0, 0), (self.qtgui_freq_sink_x_0, 1))
...
def main(top_block_cls=Labo3_3, options=None):
