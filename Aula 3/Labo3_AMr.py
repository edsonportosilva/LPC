...
class Labo3_AMr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Receptor de AM")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Receptor de AM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Labo3_AMr")
        ...
        self.audio_rate = audio_rate = 48*10**3
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/Users/ecg/Downloads/AM_Radio_1.csv', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate/self.resamp_factor)
...
def main(top_block_cls=Labo3_AMr, options=None):
